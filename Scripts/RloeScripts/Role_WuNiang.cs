...
public class Role_WuNiang :Role_Main  {
	...
	void Start(){
		skillPrefab = Resources.Load<GameObject> ("TeXiao/WuNiangSkill");
	...
	public override void SetSkill_Q ()
	{
		...
		if (tmp != null) {
			tmp.GetComponent<WuNiangSkillControl> ().camp = this.roleCamp;
			tmp.GetComponent<WuNiangSkillControl> ().owner = this;
		}
